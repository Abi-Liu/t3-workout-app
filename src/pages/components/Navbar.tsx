      ...
      {sessionData?.user ? (
        <div className="navbar-start">
          <div className="dropdown">
            ...
            >
              <li>
                <Link href={`/diet/${sessionData.user.id}`}>Diet Plan</Link>
              </li>
              <li>
                <Link href={`/workout/${sessionData.user.id}`}>
                  Workout Routine
                </Link>
              </li>
              {/* <li>
          ...
          <a className="btn btn-ghost text-xl normal-case">Fitness Tracker</a>
        </div>
      ) : (
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              className="menu dropdown-content rounded-box menu-sm z-[1] mt-3 w-52 bg-base-100 p-2 shadow"
            >
              <li onClick={() => void signIn()}>
                <a>Sign in</a>
              </li>
              <li>
                <a onClick={() => void signIn()}>Sign Up</a>
              </li>
              {/* <li>
              <a>Item 3</a>
            </li> */}
